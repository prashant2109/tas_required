...
class update_xml():
    def __init__(self):
        ...
        dbconnstr = "localhost#root#tas123"
    ...
    def assign_id_for_dummy_cell(self, cell_dict, pageno, empty_id):
            ...
            for emp_k in emp_keys:
                ...
                empty_id+=1
                m_flag = 1
            return cell_dict, empty_id, m_flag
    ...
    def get_allresid_celldict_to_web(self,project_id, url_id,normresid_dict):
        for (docid, pageno), norm_resid_st in normresid_dict.items():
            ...
            for kk, vv in all_cell_dict.items():
                vv, max_id, m_flag = self.assign_id_for_dummy_cell(vv, pageno,max_id) 
                if m_flag:

...
import slt_map_sectiontype_my as slt_map_sectiontype
...
class Delta(object):
    ...
    def generate_map_ds(self, project_id, url_id, norm_table_id, doc_id):
        ...
        #    #celldata = self.Mobj.run_process(norm_table_id, deal_id)
        #except:
        #    print 'deal_id, norm_table_id>> :: ERROR',[deal_id, norm_table_id]
        #    return
        #try:
        #    celldata = self.Mobj.run_process(norm_table_id, deal_id)
        #except:
...
if __name__ == "__main__":
    ...
    #for company_id in company_list1 + company_list2:
    #for company_id in ['1_76', '1_48', '1_79', '1_75', '1_51']:
    for company_id in ['3_152']:#['1_79', '1_70', '1_78', '1_40', '1_43', '1_65']:
        ...
        try:
            ...
            print "ERROR company", company_id, e
        '''

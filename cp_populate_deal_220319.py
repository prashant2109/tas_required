...
class Populate_deal(object):
    ...
    def populate_whole_deal(self):
        ...
        if 0:
            os.system('python /root/databuilder_train_ui/tenkTraining/Data_Builder_Training/pysrc/index_all_table.py %s'%(self.company_id))
        ...
        # Index_tag
        if 1: 
            cmd_indextag = 'python /root/databuilder_train_ui/tenkTraining/Working_Table_Tagging_Training_V2/pysrc/Index_tag.py %s' 'ALL'%(self.company_id)
